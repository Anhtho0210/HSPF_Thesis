...
from agents.agent3_matcher import agent_3_filter_node

# --- Import nodes from Agent 4 ---
from agents.agent4_checklist import agent_4_checklist_node
from agents.agent5_planner import agent_5_planner_node
from agents.agent6_report import agent_6_report_node
...
def build_master_workflow():
    ...
    # Add Agent 3 Nodes
    # Note: We merged filtering & ranking into ONE node in agent3_matcher.py
...
if __name__ == "__main__":
    ...
    # 1. Prepare Data
    pdf_filename = "transcripts/PROFILE_005_PK_MKT_Transcript.pdf"
